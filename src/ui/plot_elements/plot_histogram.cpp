...
void register_plot_histogram() {
  ...
  {
    auto proto = dynamic_ptr{"PlotHistogram"_rkey, {}};
    proto->addField(
        "values"_rkey,
        field{
            std::vector<float>{},
    ...
    proto->addField(
        ...
        field{
            ...
            attr<Description>("Number of bins.  "
    ...
    proto->addField(
        ...
        field{
            ...
            attr<Description>("Minimum sample value to include.  "
    ...
    proto->addField(
        ...
        field{
            ...
            attr<Description>("Maximum sample value to include.  "
                              "When range_min == range_max (default 0/0), ImPlot auto-ranges."),
            attr<Category>("Behavior")});
    (*proto)[dynamic::CLASS].addAttribute(attr<DisplayName>("PlotHistogram"));
    (*proto)[dynamic::CLASS].addAttribute(
        attr<Description>("Draws a 1-D frequency histogram of the values array.  "
  ...
  {
    auto proto = dynamic_ptr{"PlotHistogram2D"_rkey, {}};
    proto->addField(
        "xs"_rkey,
        field{
            std::vector<float>{},
    ...
    (*proto)[dynamic::CLASS].addAttribute(
        attr<Description>("Draws a 2-D frequency heatmap of the (xs, ys) sample pairs.  "
                          "Must be a child of a Plot element."));
    dynamic::addClass(
        "wish"_key,
        std::move(proto),
