...
void register_plot() {
  ...
  // Plot — ImPlot window container.  Children should be PlotItem elements.
  {
    ...
    proto->addField("title"_key, field{std::string{"##plot"},
      attr<DisplayName>("Title"),
      attr<Description>(
          "Plot title shown at the top of the frame; "
    ...
    proto->addField("height"_key, field{float{300.0f},
    ...
    proto->addField("x_flags"_key, field{int32_t{0},
      ...
      attr<Description>(
          "ImPlotAxisFlags for the primary X axis.  "
