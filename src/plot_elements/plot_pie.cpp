...
void register_plot_pie() {
  ...
  proto->addField(
      ...
      field{
          ...
          attr<Description>("Newline-separated list of slice labels, "
  ...
  proto->addField(
      ...
      field{
          ...
          attr<Description>("Array of slice magnitudes.  "
  ...
  proto->addField(
      ...
      field{
          ...
          attr<Description>("X coordinate of the pie center in plot (data) units [0, 1]."),
  ...
  proto->addField(
      ...
      field{
          ...
          attr<Description>("Y coordinate of the pie center in plot (data) units [0, 1]."),
          attr<Category>("Layout"),
          attr<Range>(0.0, 1.0)});
  proto->addField(
      "radius"_key,
  ...
  proto->addField(
      ...
      field{
          ...
          attr<Description>("When true, slices are proportional to their values "
  ...
  proto->addField(
      ...
      field{
          ...
          attr<Description>("Angle in degrees at which the first slice begins (0° = 3 o'clock, "
                            "90° = 12 o'clock)."),
          attr<Category>("Appearance"),
          attr<Range>(0.0, 360.0)});
  (*proto)[dynamic::CLASS].addAttribute(attr<DisplayName>("PlotPieChart"));
  (*proto)[dynamic::CLASS].addAttribute(
      attr<Description>("Draws a pie chart.  "
