...
void render_vertical_layout(imgui_renderer& r, const ui_element& node, session& s);
void render_horizontal_layout(imgui_renderer& r, const ui_element& node, session& s);
...
void render_collapsing_header(imgui_renderer& r, const ui_element& node, session& s);
