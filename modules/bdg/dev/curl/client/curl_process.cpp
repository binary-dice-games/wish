...
/// @file curl_process.cpp
/// @brief libuv-based implementation of run_curl_cli().
///
...
process_result run_curl_cli(const std::vector<std::string>& args, const std::string& binary) {
