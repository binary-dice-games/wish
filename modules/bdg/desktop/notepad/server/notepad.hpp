...
///
/// The Notepad never lists a client's local directory itself (it has no way
...
class notepad : public form {
 public:
  explicit notepad(bison::dynamic&& base);
...
/// @brief Register Notepad in the "wish" bison namespace.
